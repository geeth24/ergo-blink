...
const primaryFeatures = [
  {
    name: "Bad posture detection and correction",
    description:
  ...
  {
    name: "Blink interval detection and reminder",
    description:
  ...
  {
    name: "Screen time reminders and suggestions",
    description:
...
const secondaryFeatures = [
  ...
  },
  {
    ...
    description: "Used for running the application and training the model",
    icon: SiJupyter,
  },
  {
    name: "OpenCV",
  ...
  {
    name: "Mediapipe",
    description: "Used for detecting the landmarks on the face and eyes",
    icon: SiFaceit,
  },
  {
    name: "Next.js",
          ...
          <div className="relative isolate overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl px-6  pt-10 lg:flex lg:px-8">
              <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
                ...
                alt="Your Company"
              /> */}
                <EyeIcon className="h-11 text-indigo-500" />
                ...
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  A fully functioning application that helps you maintain good
                ...
                <div className="mt-10 flex items-center gap-x-6">
                  <Link
                    href="https://github.com/Alexander-N-Chin/ErgoBlink"
                    className="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400"
                  >
                    Get started
                  </Link>
                  <Link
                    href="https://youtu.be/X1cxh6VUQko"
          ...
          <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">
                Maintain good eye health and posture while using digital
                devices.
              </p>
              <p className="mt-6 text-lg leading-8 text-gray-300">
          ...
          <div className="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
            ...
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
                Download our app today and start using it to improve your
          ...
          <div className="mx-auto max-w-7xl px-6 pb-8 pt-4 lg:px-8">
            <div className="border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
              ...
              <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
                &copy; {new Date().getFullYear()} ErgoBlink. All rights
                reserved.
              </p>
            </div>
          </div>
